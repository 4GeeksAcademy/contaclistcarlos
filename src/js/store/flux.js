const getState = ({ getStore, getActions, setStore }) => { 
    return {
        ...
        actions: {
            createUser: () => {
                fetch("https://playground.4geeks.com/contact/agendas/carlosgut", {
                    method: "POST",
            ...
            getInfoContacts: () => {
                fetch("https://playground.4geeks.com/contact/agendas/carlosgut/contacts", {
                    method: "GET"
                })
                    .then((response) => {
            ...
            deleteContact: (id) => {
                fetch(`https://playground.4geeks.com/contact/agendas/carlosgut/contacts/${id}`, {
                    method: "DELETE",
                })
                    .then((response) => {
